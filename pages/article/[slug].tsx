        ...
        <div className="prose lg:prose-xl mx-auto mt-10">
          ...
          <div className="flex items-center space-x-2 pb-10">
            ...
            <EmailShareButton
              ...
              url={process.browser ? window.location.href : ''}
            >
              <button className="inline-flex items-center justify-center w-11 h-11 bg-gray-500 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-300 hover:bg-gray-400 transition ease duration-200">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
